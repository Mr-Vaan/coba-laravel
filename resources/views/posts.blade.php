...
@section('container')
    ...
    @if($posts->count())
        <div class="card mb-3">
            <img src="https://source.unsplash.com/user/c_v_r/1600x900?{{ $posts[0]->category->name }}" class="card-img-top" alt="{{ $posts[0]->category->name }}">
            ...
            @foreach($posts->skip(1) as $post)
                <div class="col-md-4 mb-3">
                    <div class="card">
                        ...
                        <img src="https://source.unsplash.com/user/c_v_r/1600x900?{{ $post->category->name }}" class="card-img-top" alt="{{ $post->category->name }}">
                        <div class="card-body">
